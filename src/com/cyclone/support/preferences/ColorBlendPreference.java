...
package com.cyclone.support.preferences;
...
//import com.android.internal.util.cyclone.cycloneUtils;

import com.cyclone.support.R;
import com.cyclone.support.colorpicker.ColorPickerDialog;
...
public class ColorBlendPreference extends Preference
    ...
    private void updateDialogSliderPreview() {
        ...
        /*mDialogPreviewColorBetween.setBackgroundColor(
                cycloneUtils.getBlendColorForPercent(mPreviewColorEnd, mPreviewColorStart,
    ...
    private void updatePreview() {
        ...
        /*if (mViewColorBetween != null) {
            mViewColorBetween.setBackgroundColor(
                    cycloneUtils.getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50));
        }*/
    }
